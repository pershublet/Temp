class Solution
{
    ...
    )
    {
        ...
        {
            array[i][0] = bottomLeft[i][0];
            array[i][1] = bottomLeft[i][1];
            array[i][2] = topRight[i][0];
            array[i][3] = topRight[i][1];
        }
